...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  themeConfig: {
    ...
    author: {
      name: 'Mijac', // 必需
      link: 'https://github.com/mijaclan', // 可选的
    },

    // 博主信息 (显示在首页侧边栏)
    blogger: {
      avatar: 'https://avatars.githubusercontent.com/u/55379474',
      name: 'Mijac',
      slogan: '一个计算机专业的小学弟，还请大佬赐教~',
    },
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'mailto:mijac.lan@gmail.com',
        },
        {
        ...
        },
        {
          iconClass: 'icon-erji',
          title: '听音乐',
          link: 'https://music.163.com/#/playlist?id=7321652442',
        },
      ],
    },
    ...
    footer: {
      ...
      copyrightInfo:
        'Mijaclan | <a href="https://github.com/mijaclan" target="_blank">MIT License</a>', // 博客版权信息、备案信息等，支持a标签或换行标签</br>
    },
